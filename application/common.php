...
//后台上传图片
function upload($k,$base_path = 'upload/admin/',$maxsize = 512) {
    if(checkfile($k,$maxsize) !== true) {
        return array('error'=>1,'msg'=>checkfile($k,$maxsize));
    }
...
function rename_file($tmp,$path = 'upload/api/') {
